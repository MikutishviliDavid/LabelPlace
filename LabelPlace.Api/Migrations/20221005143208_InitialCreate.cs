        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "text", nullable: false),
                    SourceDataUrl = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LabeledText = table.Column<string>(type: "jsonb", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TextAnnotations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TextAnnotations_Projects_ProjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TextAnnotations_ProjectId",
